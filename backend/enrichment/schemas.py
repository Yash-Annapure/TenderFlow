...
PAST_TENDER_SCHEMA: dict = {
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "contract_value_eur": {"type": "number"},
            "contract_duration_months": {"type": "integer"},
...
COMPANY_PROFILE_SCHEMA: dict = {
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "annual_turnover_eur": {"type": "number"},
            "team_size_fte": {"type": "integer"},
